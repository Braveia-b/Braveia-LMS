...
<section class="hero-section text-center">
    <div class="container">
        <h1 class="mb-4">Tingkatkan Karirmu Bersama Braveia.</h1>
        <p class="mb-5">Platform e-learning bersertifikasi dan bimbingan mentor profesional berbasis AI recommendation.</p>
        <div class="d-flex justify-content-center gap-3">
            <a href="<?= base_url('courses') ?>" class="btn btn-light btn-lg text-primary fw-bold px-4 py-3">Mulai Belajar</a>
            <a href="<?= base_url('about') ?>" class="btn btn-outline-light btn-lg px-4 py-3">Jelajahi Program</a>
        </div>
        
        <div class="row mt-5 pt-4 border-top border-light border-opacity-25 text-white">
...
<section class="py-5 bg-white">
    <div class="container py-4">
        <div class="text-center mb-5">
            ...
            <p class="text-muted">Pelajari keahlian yang paling dicari di industri saat ini.</p>
        </div>
            ...
            <div class="col-md-4">
                <div class="card course-card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <h5 class="card-title fw-bold">Data Analytics for Business</h5>
            ...
            <div class="col-md-4">
                <div class="card course-card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <h5 class="card-title fw-bold">Professional UI/UX Masterclass</h5>
        ...
        <div class="text-center mt-5">
            <a href="<?= base_url('courses') ?>" class="btn btn-outline-secondary px-4">Lihat Semua Program <i class="fas fa-arrow-right ms-2"></i></a>
        </div>
    </div>
</section>
    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                <div class="pe-md-5">
                    <span class="text-primary fw-bold">✨ FITUR BARU</span>
                    <h2 class="fw-bold mt-2 mb-4">Didukung oleh AI Recommendation</h2>
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-2"></i> Rekomendasi kelas otomatis</li>
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-2"></i> Skill gap analysis</li>
                        <li class="mb-3"><i class="fas fa-check-circle text-success me-2"></i> Pencocokan mentor yang tepat</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
                <div class="p-4 bg-white rounded-4 shadow-sm border text-center">
                    ...
                    <h4 class="fw-bold">Career Roadmap Builder</h4>
